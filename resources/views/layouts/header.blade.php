            ...
            <div class="header">
                <div class="header__right">
                    <div class="header__logo"><a href="/home">
                            <picture>
                                <img src="{{ asset('img/logo-300x51.webp') }}" loading="lazy" alt="logo" />
                            </picture>
                        </a></div>
                ...
                <nav>
                    <div class="menu-toggle" onclick="toggleMenu()"><svg width="24" height="24"
                    ...
                    <ul class="nav__main">
                        <span class="menu-close" onclick="toggleMenu()"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="dropdown">
                            <div class="dropdown-btn"><span>Posts</span><svg width="12" height="6" viewBox="0 0 4 2"
                                    ...
                                    <line x1="0" y1="0" x2="2" y2="1.5" stroke="black" stroke-width="0.35"
                                        stroke-linecap="round" />
                                    <line x1="2" y1="1.5" x2="4" y2="0" stroke="black" stroke-width="0.35"
                                        stroke-linecap="round" />
                                </svg>
                            </div>
                        ...
                        <li class="dropdown">
                            <div class="dropdown-btn"><span>Pages</span><svg width="12" height="6" viewBox="0 0 4 2"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <line x1="0" y1="0" x2="2" y2="1.5" stroke="black" stroke-width="0.35"
                                        stroke-linecap="round" />
                                    <line x1="2" y1="1.5" x2="4" y2="0" stroke="black" stroke-width="0.35"
                        ...
                        <li>
                            <ul class="nav__icon">
                                <li><a href="https://www.facebook.com/" id="FB"><svg width="24" height="24"
                                ...
                                <li><a href="https://x.com/" id="TW"><svg width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <li><a href="https://www.instagram.com" id="IG"><svg width="24" height="24"
                                            viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            aria-hidden="true" focusable="false">
                                            <path fill="currentColor"
                                ...
                                <li><a href="https://www.youtube.com/" id="YT"><svg width="24" height="24"
                                            viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            aria-hidden="true" focusable="false">
                                            <path fill="currentColor"
